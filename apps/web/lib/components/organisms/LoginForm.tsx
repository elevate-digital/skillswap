  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-3 login-form">
      <EmailField
        ...
        placeholder="Bijv. janjansen@gmail.com"
      />
      ...
      <PasswordField
        ...
        value={form.password}
        onChange={handleChange}
        placeholder="Hier jouw wachtwoord"
      />
      ...
      <a
        className="bg-[var(--primary-bg-color)] text-[var(--primary-text-color)] border-1 border-[var(--primary-text-color)] hover:bg-[var(--primary-text-color)] hover:text-[var(--secondary-text-color)] flex items-center justify-center gap-3 rounded-[var(--border-radius-sm)] cursor-pointer transition-colors sm:p-[12px] lg:p-[12px] py-[7px] px-[10px] lg:py-[12px] lg:px-[32px]"
        href="/"
      >
